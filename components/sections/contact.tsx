...
const inputClassName =
  "mt-1 min-h-11 w-full rounded-standard border border-border-input bg-surface px-4 py-3 text-base text-foreground outline-none transition-colors focus:border-primary focus:ring-1 focus:ring-primary dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-50 dark:focus:border-zinc-100";
...
export function Contact() {
  ...
  return (
    ...
    >
      <div className="mx-auto grid max-w-[1280px] grid-cols-1 gap-8 px-6 md:grid-cols-2 lg:gap-24">
        {/* Colonne gauche : infos */}
        <div className="space-y-8">
          <div>
            <h2
              id="contact-heading"
              className="font-headline mb-4 text-2xl font-semibold text-primary md:text-3xl dark:text-zinc-50"
            >
          ...
          <div className="space-y-3">
            {CONTACT_CHANNELS.map((channel) => (
              <a
                key={channel.label}
                href={channel.href}
                className="hover-lift flex items-center gap-4 rounded-standard border border-border bg-surface p-4 dark:border-zinc-800 dark:bg-zinc-950"
              >
                <span
                  aria-hidden="true"
          ...
          <dl className="grid gap-3 text-sm text-muted sm:grid-cols-2 dark:text-zinc-400">
            <div>
        ...
        <div className="rounded-card border border-border bg-surface p-8 ambient-shadow dark:border-zinc-800 dark:bg-zinc-950">
          <h3 className="font-headline mb-6 text-lg font-bold text-primary dark:text-zinc-50">
            Demande de devis
          </h3>
          <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
            ...
            <div className="flex items-start gap-2 py-2">
              <input
                ...
                className="mt-1 h-5 w-5 shrink-0 rounded border-border-input text-primary focus:ring-primary dark:border-zinc-700"
              />
              <label htmlFor="contact-consentement" className="text-sm text-muted dark:text-zinc-400">
